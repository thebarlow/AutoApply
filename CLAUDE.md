...
2. **Generate** — produce tailored resume + cover letter per job using Claude, render resume to PDF
...
| Resume/cover letter generation, LaTeX template, Claude prompts, PDF rendering | `2_generator/` | Modifying how resumes or cover letters are produced |
