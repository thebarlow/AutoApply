...
- When improving keyword coverage, do not phrase anything so a reader could infer a title, seniority, ownership, or outcome the applicant did not actually hold or produce. Borrowing the job's vocabulary is fine; implying a role or result is not.
